...
from utils.eval_det import eval_det_multiprocessing, eval_grounding, get_iou_obb
...
def parse_predictions(end_points, config_dict, prefix="", size_cls_agnostic=False):
    ...
    if config_dict.get('hungarian_loss', False):
        ...
        if f'{prefix}objectness_scores' in end_points:
            ...
            obj_prob = (1 - sem_cls_probs[:,:,-1]) # (B,K)
...
class APCalculator(object):
    ...
    def compute_accuracy(self):
        ...
        results = eval_grounding(self.pred_map_cls, self.gt_map_cls, ovthresh=self.ap_iou_thresh)
        return results
